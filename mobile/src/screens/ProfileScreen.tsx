...
const styles = StyleSheet.create({
  ...
  toggle: { flexDirection: 'row', backgroundColor: colors.chip, borderRadius: radius.pill, padding: 2, borderWidth: 1, borderColor: colors.border },
  toggleItem: { paddingHorizontal: 12, paddingVertical: 5, borderRadius: radius.pill },
  toggleItemActive: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.borderStrong },
  ...
  stat: { flex: 1 },
  statValue: { fontSize: 17, fontWeight: '600', color: colors.primary, marginTop: 2 },
  linkRow: { flexDirection: 'row', alignItems: 'center', marginTop: spacing.md, backgroundColor: colors.surface, borderRadius: radius.sm, borderWidth: 1, borderColor: colors.borderStrong, overflow: 'hidden' },
  link: { flex: 1, fontSize: 12, color: colors.textSecondary, paddingHorizontal: spacing.md, paddingVertical: 9 },
  copy: { fontSize: 12.5, fontWeight: '600', color: colors.primary, paddingHorizontal: spacing.md, paddingVertical: 9, borderLeftWidth: 1, borderLeftColor: colors.borderStrong },
