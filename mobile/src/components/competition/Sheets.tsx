...
const styles = StyleSheet.create({
  ...
  summaryRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, padding: spacing.md },
  providerRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  provider: { fontSize: 13.5, fontWeight: '500', color: colors.text },
  amount: { fontSize: 17, fontWeight: '600', color: colors.primary },
  ...
  inputLabel: { ...typography.eyebrow, marginBottom: spacing.xs, marginTop: spacing.md },
